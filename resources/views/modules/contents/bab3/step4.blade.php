                    ...
                    <div>
                        ...
                        <ul class="space-y-3 text-xs md:text-sm text-justify">
                            <li class="flex items-start gap-3">
                                ...
                                <span class="leading-relaxed"><strong>Durasi Waktu:</strong> Anda memiliki waktu <strong>10 Menit</strong>. Timer akan berjalan otomatis saat tombol mulai ditekan. Jika waktu habis, jawaban akan otomatis dikumpulkan.</span>
                            </li>
                            <li class="flex items-start gap-3">
        ...
        <div id="modal-konfirmasi" class="fixed inset-0 bg-slate-900/50 z-[9999] flex items-center justify-center p-4 hidden">
            <div class="bg-white rounded-xl p-6 max-w-sm w-full shadow-2xl transform scale-100 transition-transform">
                ...
                <div class="flex justify-end gap-3">
                    ...
                    <button onclick="q3_aksiFinalisasi()" class="px-4 py-2 rounded bg-red-600 text-white hover:bg-red-700 font-bold text-sm shadow">YA, KUMPULKAN</button>
                </div>
            </div>
        </div>
        ...
        <div id="modal-hasil" class="fixed inset-0 bg-white z-[9999] flex items-center justify-center p-4 hidden">
            <div class="text-center">
                ...
                <div class="flex gap-3 justify-center">
                    <button onclick="q3_aksiUlangi()" class="btn-ulangi-quiz px-6 py-3 border border-slate-200 rounded-lg font-bold text-slate-600 hover:bg-slate-50">
                        ULANGI
                    </button>
                    <button onclick="q3_aksiReviewJawaban()" class="btn-lihat-quiz px-6 py-3 bg-slate-800 text-white rounded-lg font-bold hover:bg-slate-900 shadow-lg">
                        LIHAT PEMBAHASAN
                    </button>
                    <a href="{{ route('dashboard') }}" class="px-6 py-3 bg-blue-600 text-white rounded-lg font-bold hover:bg-blue-700 shadow-lg">
                        DASHBOARD
                    </a>
                </div>
            </div>
...
<script>
    ...
    function q3_aksiMulaiUjian() {
        ...
        window.q3_timerUjian = setInterval(() => {
            ...
            if (window.q3_sisaDetik <= 0) q3_aksiFinalisasi();
        }, 1000);
    }
</script>