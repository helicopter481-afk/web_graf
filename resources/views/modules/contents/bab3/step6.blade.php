<section id="step-6" class="step-slide">
    <div class="bg-white rounded-xl border border-slate-200 shadow-sm p-10 -mt-8">
        ...
        <div class="flex justify-between gap-4 mt-12">
            ...
            <button type="button" onclick="finishChapter()" class="btn-primary">Selesai Materi 3</button>
        </div>
    ...
    <script>
        function finishChapter() {
            ...
            fetch("{{ route('submit.reflection') }}", {
                    ...
                    body: JSON.stringify({
                        chapter: 'bab3', // Pastikan sesuai bab
                        answers: answers
                    })
                })
                ...
                .then(data => {
                    if (data.redirect || data.status === 'success') {
                        Swal.fire({
                            title: 'Luar Biasa!',
                            text: 'Bab 3 Selesai. Refleksi Anda telah tersimpan.',
                            icon: 'success',
